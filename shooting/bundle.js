...
/***/ function(module, exports, __webpack_require__) {
	...
	window.onload = function () {
	  ...
	  var horst = { x: 0, y: 0, mapSeg: 0, speed: 0.6, k: 0, color: "blue" }; // speed in pixel per frame
	  var marlene = { x: 0, y: 0, mapSeg: 0, speed: 0.8, k: 0, color: "green" }; // speed in pixel per frame
	  var markus = { x: 0, y: 0, mapSeg: 0, speed: 0.4, k: 0, color: "red" }; // speed in pixel per frame
	  ...
	  function gameLoop() {
	    ...
	    var activeTowers = towers.filter(function (tower) {
	      return !tower.activeIn;
	    });

	    activeTowers.forEach(function (tower) {
	      tower.target = shoot.checkEnemyinRange(tower, enemies);
	    });

	    var shootingTowers = activeTowers.filter(function (tower) {
