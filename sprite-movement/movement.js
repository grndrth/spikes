export function moveToNextPosition (enemy, enemyInd, mapData, deadEnemies) {
  ...
  let {x: oldX, y: oldY, mapSeg: index, speed: direction, k: pos} = enemy;
...
export function calcOrientation(enemy, oldX, oldY) {
  let {x: nextX, y: nextY} = enemy;
  let deltaX = nextX - oldX;
  let deltaY = nextY - oldY;
