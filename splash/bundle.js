...
/***/ function(module, exports, __webpack_require__) {
	...
	var _shooting = __webpack_require__(2);

	var shoot = _interopRequireWildcard(_shooting);
	...
	window.onload = function () {
	  ...
	  var feind2 = { id: 2, x: 0, y: 0, mapSeg: 0, speed: 0.8, k: 0, color: "blue", hit: 10, strength: 10 }; // speed in pixel per frame
	  var feind3 = { id: 3, x: 0, y: 0, mapSeg: 0, speed: 0.7, k: 0, color: "red", hit: 10, strength: 10 }; // speed in pixel per frame
	  var feind4 = { id: 4, x: 0, y: 0, mapSeg: 0, speed: 0.6, k: 0, color: "green", hit: 10, strength: 10 }; // speed in pixel per frame
	  var feind5 = { id: 5, x: 0, y: 0, mapSeg: 0, speed: 0.5, k: 0, color: "blue", hit: 10, strength: 10 }; // speed in pixel per frame
	  var feind6 = { id: 6, x: 0, y: 0, mapSeg: 0, speed: 0.4, k: 0, color: "red", hit: 10, strength: 10 }; // speed in pixel per frame
	  ...
	  function drawTower(tower) {
	    ...
	    var ready = tower.activeIn;

	    var towerColor = "olive";
	  ...
	  function drawShoot(tower) {
	    var xT = tower.x;
	    var yT = tower.y;
	    var i = tower.targetIndex;
	    var _enemies$i = enemies[i];
	    var xE = _enemies$i.x;
	    var yE = _enemies$i.y;
	  ...
	  function gameLoop() {
	    ...
	    var sleepingTowers = towers.filter(function (tower) {
	      return tower.activeIn > 0;
	    });

	    var readyTowers = towers.filter(function (tower) {
	      return tower.activeIn === 0 && tower.target === -1;
	    });

	    var reloadingTowers = towers.filter(function (tower) {
	      return tower.activeIn <= -tower.shootDuration;
	    });

	    var shootingTowers = towers.filter(function (tower) {
	      return tower.target >= 0;
	    });

	    sleepingTowers.forEach(function (tower) {
	      tower.activeIn -= 1;
	    });
	    ...
	    readyTowers.forEach(function (tower) {
	      var targetIndex = shoot.checkEnemyinRange(tower, enemies);
	      if (targetIndex >= 0) {
...
/***/ function(module, exports) {
	...
	function deleteEnemies(enemies, deadEnemies) {
	  deadEnemies.sort(sortAscending);
...
/***/ function(module, exports) {
	...
	function checkEnemyinRange(tower, enemies) {
	  var target = enemies.findIndex(function (enemy) {
	    var x1 = tower.x;
	    var y1 = tower.y;
	    var x2 = enemy.x;
	    var y2 = enemy.y;
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(10)(IteratorPrototype, __webpack_require__(35)('iterator'), function () {
	  return this;
	});
